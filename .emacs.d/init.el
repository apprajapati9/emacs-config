(custom-set-variables
 ...
 '(package-selected-packages
   '(smartparens expand-region multiple-cursors move-text gruber-darker-theme dash-functional dash format-all clang-format yasnippet projectile hydra flycheck company avy which-key))
